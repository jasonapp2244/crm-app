    ...
    'installer' => [
        'index' => [
            ...
            'installation-processing' => [
                'crm' => 'نصب کرایین',
                'crm-info' => 'در حال ایجاد جداول پایگاه داده، این ممکن است چند لحظه طول بکشد',
                'title' => 'نصب',
            ],

            'installation-completed' => [
                'admin-panel' => 'پنل مدیریت',
                'crm-forums' => 'انجمن کرایین',
                'customer-panel' => 'پنل مشتری',
                'explore-crm-extensions' => 'کاوش افزونه‌های کرایین',
                'title' => 'نصب کامل شد',
            ...
            'back' => 'بازگشت',
            'crm' => 'کرایین',
            'crm-info' => 'یک پروژه اجتماعی توسط',
            'crm-logo' => 'لوگوی کرایین',
            'continue' => 'ادامه',
